window.onload = function () {
    listarViajesFavoritos();
    marcarFavoritos();
}

let listarViajesFavoritos = async () => {
    ...
    const viajesFavoritos = await peticion.json();

    let contenidoTabla = "";
    viajesFavoritos.forEach(viajeFavorito => {
        let contenidoFila = `<tr>
            <td>${viajeFavorito.viaje.id}</td>
            <td>${viajeFavorito.viaje.empresa}</td>
            <td>${viajeFavorito.viaje.origen}</td>
            <td>${viajeFavorito.viaje.destino}</td>
            <td>${viajeFavorito.viaje.fecha}</td>
            <td>${viajeFavorito.viaje.duracion}</td>
            <td>${viajeFavorito.viaje.precio}</td>
            <td>${viajeFavorito.viaje.asientosTotales}</td>
            <td>${viajeFavorito.viaje.asientosDisponibles}</td>
            <td>${viajeFavorito.viaje.oferta}</td>
            <td>
            <i onClick="compararViaje(${viajeFavorito.viaje.id}) "class="material-icons button search">search</i>
            </td>
            <td>
            <i id="estrella-${viajeFavorito.viaje.id}" onClick="favorito(${viajeFavorito.viaje.id})"class="material-icons button star">star</i>
            </td>
            <td>
            <i onClick="reservarViaje(${viajeFavorito.viaje.id})"class="material-icons button check_circle">check_circle</i>
            </td>
        </tr>
        ` 
